      ...
      <div className=''>
        ...
        {isSignUpActive && (
          <div className='flex flex-1 justify-center gap-2 pb-8'>
            ...
            <br />
            <a onClick={handleMethodChange} className='hover:text-beep-100'>Login</a>
        ...
        {!isSignUpActive && (
          ...
          <div className='flex flex-1 justify-center gap-2'>
            ...
            <br />
            <a onClick={handleMethodChange} className='hover:text-beep-100 pb-8'>Click here to create one!</a>
          </div>
        )}
      </div>
    </div>
