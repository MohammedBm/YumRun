...
-- CreateIndex
CREATE UNIQUE INDEX "User_userename_key" ON "User"("userename");
...
-- AddForeignKey
ALTER TABLE "Update" ADD CONSTRAINT "Update_prodductId_fkey" FOREIGN KEY ("prodductId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
